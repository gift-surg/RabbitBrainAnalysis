...
from tools.definitions import root_study_rabbits, root_internal_template, pfo_subjects_parameters
...
def propagate_and_fuse_per_subject_list_over_all_modalities(subj_list,
    ...
    template_subjects = get_list_names_subjects_in_template(pfo_subjects_parameters)

    print '\n\n Propagating and fusing per category. ' \
          'Target group folder {0}\n' \
          'Subjects template {1}\n'.format(subj_list, template_subjects)
    ...
    for sj_target in subj_list:
        ...
        if sj_target in template_subjects:
            ...
            propagate_all_to_one(sj_target, pfo_target, root_internal_template, template_subjects, controller_fuser)
