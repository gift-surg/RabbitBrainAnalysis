...
def subject_comparison_volume_per_region(sj_list, ldm, labels_num, controller, macro_label_name=None,
...
def subject_comparison_values_below_labels_per_region(sj_list, ldm, labels_num, controller, macro_label_name=None,
                                                      coord_system='original', mod='FA', cleaning=None):
    """
...
if __name__ == '__main__':
    ...
    if True:
        ...
        subject_comparison_total_volume(subjects, controller=controller_, coord_system='original')
        ...
        for reg in ptb_related_regions.keys():
            ...
            for coordinates in ['original', 'stereotaxic']:
                subject_comparison_volume_per_region(subjects, ldm, ptb_related_regions[reg], controller_,
                                                     macro_label_name=reg, coord_system=coordinates, cleaning=None)
        ...
        for reg in ptb_related_regions.keys():
            ...
            for coordinates in ['original', 'stereotaxic']:
                ...
                subject_comparison_values_below_labels_per_region(subjects, ldm, ptb_related_regions[reg], controller_,
                                                                  macro_label_name=reg, coord_system=coordinates,
                                                                  mod='FA', cleaning=None)

                # comparison MD
                subject_comparison_values_below_labels_per_region(subjects, ldm, ptb_related_regions[reg], controller_,
                                                                  macro_label_name=reg, coord_system=coordinates,
                                                                  mod='MD', cleaning=None)
