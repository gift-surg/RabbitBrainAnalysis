...
def process_T1_per_subject(sj, controller):
    ...
    if controller['register_roi_masks']:
        ...
        controller['register_roi_masks_slim'] = False
    ...
    if controller['register_roi_masks_slims']:
    ...
    if controller['cut_masks']:
        ...
        print_and_run(cmd)
        del cmd, pfi_std, pfi_3d_cropped_roi

    if controller['step_bfc']:
