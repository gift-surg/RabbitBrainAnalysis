...
def reset_parameters_files(pfo_where_to_save):
    ...
    '''  --------- 8 Weeks old second trial------'''

    sp = SubjectParameters('13601')
    sp.study                   = 'W8'
    sp.category                = 'second_trial'
    sp.angles                  = [0, np.pi / 12, 0]
    sp.translation             = [0, 0, 0]
    sp.threshold               = 18
    sp.DWI_squashed            = False
