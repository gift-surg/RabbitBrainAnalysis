...
def get_rabbit_record(list_pfi_anatomies,
    ...
    return {'Subject info': se_subject_info, 'Measurements' : measurements}


def save_rabbit_record(rabbit_record, pfo_output, verbose=1):
    """
    ...
    # -- save in .pickle
    pickle.dump(rabbit_record, jph(pfo_output, fin_output + '.pickle'))
