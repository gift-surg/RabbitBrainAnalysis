...
root_test = '/Users/sebastiano/Documents/UCL/a_data/bunnies/pipelines/in_vivo_DWI/zz_test'

dwi_image = os.path.join(root_test, '0802_t1_DWI.nii.gz')
dwi_txt = os.path.join(root_test, '0802_t1_DWI.txt')
...
step_correct_slope     = True
step_perform_dti       = True
step_open_and_see      = True
...
if step_reorient:
    ...
    dwi_reoriented_image = os.path.join(root_test, '0802_t1_reoriented.nii.gz')
    cmd = ''' cp {0} {1};
...
if step_extract_first_slice:
    ...
    path_dwi = os.path.join(root_test, '0802_t1_reoriented.nii.gz')
    path_first_slice_dwi_extracted = os.path.join(root_test, 'masks', '0802_t1_reoriented_first_slice.nii.gz')
...
if step_cut_to_mask_dwi:
    ...
    path_dwi = os.path.join(root_test, '0802_t1_reoriented.nii.gz')
    path_mask = os.path.join(root_test, 'masks', 'oriented_roi_mask.nii.gz')
    path_dwi_cropped = os.path.join(root_test, '0802_t1_reoriented_cropped.nii.gz')
...
if step_correct_slope:
        ...
        path_input_dwi = os.path.join(root_test, '0802_t1_reoriented_cropped.nii.gz')
        path_output_dwi_slope_corrected = os.path.join(root_test, '0802_t1_slope_corrected.nii.gz')
...
if step_perform_dti:
    ...
    path_input_dwi    = os.path.join(root_test, '0802_t1_slope_corrected.nii.gz')
    ...
    path_output_dti    = os.path.join(output_folder, 'fsl')
