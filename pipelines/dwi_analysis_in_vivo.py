...
from definitions import root_in_vivo_dwi, root_ex_vivo_template
...
# Parameters
subjects = ['0802_t1']  # , '1203', '1305', '1404', '1507', '1510', '1702', '1805', '2002']
dil_mask_factor = 5
...
if step_squeeze:
    ...
    for sj in subjects:
        ...
        path_dwi_nii_squeezed = os.path.join(root_in_vivo_dwi, sj, 'DWI', sj + '_DWI.nii.gz')
...
if step_extract_bval_bvect_slope:
    ...
    for sj in subjects:
        ...
        path_dwi_txt_input = os.path.join(root_in_vivo_dwi, sj, 'DWI', sj + '_DWI.txt')
...
if step_extract_first_slice:
    for sj in subjects:
        ...
        cmd_0 = 'mkdir -p {0}'.format(os.path.join(root_in_vivo_dwi, sj, 'masks'))

        path_oriented_as_dwi_1305_3d_template = os.path.join(root_in_vivo_dwi, 'templates', '1305_3D.nii.gz')
        path_oriented_as_dwi_1305_3d_ciccione = os.path.join(root_in_vivo_dwi, 'templates', '1305_3D_mask_fin_dil5.nii.gz')

        path_dwi = os.path.join(root_in_vivo_dwi, sj, 'DWI', sj + '_DWI.nii.gz')
        path_first_slice_dwi_extracted = os.path.join(root_in_vivo_dwi, sj, 'masks', sj + '_first_slice_DWI.nii.gz')
...
if step_create_1d_layer_mask:
    ...
    for sj in subjects:
        ...
        cmd_0 = 'mkdir -p {0}'.format(os.path.join(root_in_vivo_dwi, sj, 'transformations'))

        path_oriented_as_dwi_1305_3d_template = os.path.join(root_in_vivo_dwi, 'templates', '1305_3D.nii.gz')
        path_oriented_as_dwi_1305_3d_ciccione = os.path.join(root_in_vivo_dwi, 'templates', '1305_3D_mask_fin_dil5.nii.gz')

        path_affine_transformation_output = os.path.join(root_in_vivo_dwi, sj, 'transformations',
                                                         sj + '_on_unoriented_1305.txt')
        path_3d_warped_output = os.path.join(root_in_vivo_dwi, 'zz_trash', sj + '_on_unoriented_1305.nii.gz')

        path_mask_output = os.path.join(root_in_vivo_dwi, sj, 'masks', sj + '_ciccione_roi_mask.nii.gz')
...
if step_dilate_mask:
    ...
    for sj in subjects:
        ...
        path_mask = os.path.join(root_in_vivo_dwi, sj, 'masks',  sj +'_ciccione_roi_mask.nii.gz')
...
if step_cut_to_mask_dwi:
    ...
    for sj in subjects:
        ...
        path_dwi_nii_input = os.path.join(root_in_vivo_dwi, sj, 'DWI', sj + '_DWI.nii.gz')
        path_3d_nii_mask_for_dwi = os.path.join(root_in_vivo_dwi, sj, 'masks', sj + '_ciccione_roi_mask.nii.gz')
        path_dwi_cropped_roi_result = os.path.join(root_in_vivo_dwi, sj, 'DWI', sj + '_DWI_cropped.nii.gz')
...
if step_correct_the_slope:
    ...
    for sj in subjects:
        ...
        path_slopes_txt_input = os.path.join(root_in_vivo_dwi, sj, 'DWI', sj + '_VisuCoreDataSlope.txt')

        path_3d_cropped_roi = os.path.join(root_in_vivo_dwi, sj, 'DWI', sj + '_DWI_cropped.nii.gz')
        path_3d_sloped_cropped_result = os.path.join(root_in_vivo_dwi, sj, 'DWI',
...
if step_dwi_analysis_nifty_fit:
    ...
    for sj in subjects:
        ...
        path_input_dwi    = os.path.join(root_in_vivo_dwi, sj, 'DWI', sj + '_DWI_cropped_and_slope_corrected.nii.gz')
        path_input_bval   = os.path.join(root_in_vivo_dwi, sj, 'DWI', sj + '_DwEffBval.txt')
        path_input_bvect  = os.path.join(root_in_vivo_dwi, sj, 'DWI', sj + '_DwGradVec.txt')
        path_input_mask   = os.path.join(root_in_vivo_dwi, sj, 'masks',  sj +'_ciccione_roi_mask.nii.gz')

        path_output_folder = os.path.join(root_in_vivo_dwi, sj, 'analysis_fit')
        ...
        cmd_0 = 'mkdir -p {0}'.format(os.path.join(root_in_vivo_dwi, sj, 'analysis_fit'))
...
if step_reorient_nifty_fit:
    ...
    for sj in subjects:
        ...
        path_images_folder = os.path.join(root_in_vivo_dwi, sj, 'analysis_fit')
...
if step_erase_unuseful_things:
    ...
    for sj in subjects:
        ...
        path_first_slice_dwi_extracted = os.path.join(root_in_vivo_dwi, sj, 'masks', sj + '_first_slice_DWI.nii.gz')
        path_not_sloped_corrected = os.path.join(root_in_vivo_dwi, sj, 'DWI', sj + '_DWI_cropped.nii.gz')
