...
from pipelines_internal_template_OLD.A_template_atlas_in_vivo_prelim.a_definitions_regions_subjects import subjects, regions_values
...
pfi_data = jph(pfo_study, 'Preliminary', 'outcomes', 'adc_per_regions_per_subject.txt')
...
pfi_table = jph(pfo_study, 'Preliminary', 'outcomes', 'adc_per_regions_per_subject_tab.txt')
